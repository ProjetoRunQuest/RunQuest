...
function abrirModal(tipoForm){
    ...
    const modalCartao = document.getElementsByClassName('modal-cartao')
    ...
    //Verificando se é o formulário de email ou telefone
    ...
    //Verificando se é o formulário de cartão
    }else if(tipoForm == 'cartao'){
        modalCartao[0].style.top = `calc(${posicaoScroll}px + 50px)`;
        modalCartao[0].style.display = 'flex';
        containerDados.style.transition = 'all ease-in-out 300ms';
        setTimeout(function(){
            modalCartao[0].style.opacity = '1';
            containerDados.style.filter = 'blur(2px)';
        }, 500)
    }
...
function fecharModal(tipoForm){
    ...
    //Veficando se é o formulário de email ou telefone
    }else if(tipoForm == 'email' || tipoForm == 'telefone'){
    ...
    //Verificando se é o formulário de cartao
    }else if(tipoForm == 'cartao'){
        modalCartao[0].style.opacity = '0'
        containerDados.style.filter = 'unset'
        setTimeout(function(){
            modalCartao[0].style.display = 'none'
            containerDados.style.transition = 'unset'
        }, 500)
    }
}
