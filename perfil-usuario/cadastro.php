...
<body>
            ...
            <div class="container-cadastro">
                ...
                <div class="container-form-cadastro">
                    ...
                    <form action="#" class="form-cadastro">
                        ...
                        <input type="text" name="cpf" id="cpf" class="input-cadastro" placeholder="Digite seu cpf..." onkeyup="mascara(this, mascaraCPF)" maxlength="14">
    ...
    <form action="#" class="form-cadastro">
        ...
        <input type="email" name="email" id="email" class="input-cadastro" placeholder="Digite seu email...">

        <label for="endereco">Telefone:</label>
        <input type="text" name="telefone" id="telefone" class="input-cadastro" placeholder="Digite seu telefone..." onkeyup="mascara(this, mascaraTelefone)" maxlength="15">
        <span class='span-botao'><button type='submit' class='btn-cadastro'>Salvar Alterações</button></span>
    </form>
    </div>
    <!--Footer-->
